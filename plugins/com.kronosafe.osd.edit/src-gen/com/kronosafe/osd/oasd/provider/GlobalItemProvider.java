...
/**
 * This is the item provider adapter for a {@link com.kronosafe.osd.oasd.Global} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GlobalItemProvider extends IdentifiableElementReferencerItemProvider {
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Global_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Global_type_feature", "_UI_Global_type"),
				 oasdPackage.Literals.GLOBAL__TYPE,
				 true,
				 false,
				 false,
				 null,
	...
	public String getText(Object object) {
		String label = ((Global)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Global_type") :
