...
/**
 * This is the item provider adapter for a {@link com.kronosafe.osd.oasd.Parameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterItemProvider extends IdentifiableElementReferencerItemProvider {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 oasdPackage.Literals.PARAMETER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDirPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_dir_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parameter_dir_feature", "_UI_Parameter_type"),
				 oasdPackage.Literals.PARAMETER__DIR,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPointerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_pointer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parameter_pointer_feature", "_UI_Parameter_type"),
				 oasdPackage.Literals.PARAMETER__POINTER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 oasdPackage.Literals.PARAMETER__ORDER,
				 true,
				 false,
				 false,
	...
	protected void addRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parameter_ref_feature", "_UI_Parameter_type"),
				 oasdPackage.Literals.PARAMETER__REF,
				 true,
				 false,
				 true,
				 null,
