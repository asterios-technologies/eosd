...
/**
 * This is the item provider adapter for a {@link com.kronosafe.osd.oasd.Output} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputItemProvider extends IdentifiedElementItemProvider {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected void addInnerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Output_inner_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Output_inner_feature", "_UI_Output_type"),
				 oasdPackage.Literals.OUTPUT__INNER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 oasdPackage.Literals.OUTPUT__TYPE,
				 true,
				 false,
				 true,
				 null,
