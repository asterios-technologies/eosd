...
/**
 * This is the item provider adapter for a {@link com.kronosafe.osd.oasd.Input} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputItemProvider extends IdentifiedElementItemProvider {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected void addInnerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Input_inner_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Input_inner_feature", "_UI_Input_type"),
				 oasdPackage.Literals.INPUT__INNER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 oasdPackage.Literals.INPUT__TYPE,
				 true,
				 false,
				 true,
				 null,
