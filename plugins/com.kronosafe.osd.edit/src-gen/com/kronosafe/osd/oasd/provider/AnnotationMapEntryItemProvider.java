		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 oasdPackage.Literals.ANNOTATION_MAP_ENTRY__KEY,
				 true,
				 false,
				 false,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AnnotationMapEntry_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AnnotationMapEntry_value_feature", "_UI_AnnotationMapEntry_type"),
				 oasdPackage.Literals.ANNOTATION_MAP_ENTRY__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
