...
/**
 * This is the item provider adapter for a {@link com.kronosafe.osd.oad.Allocation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AllocationItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSwExecutionUnitPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Sw Execution Unit feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSwExecutionUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Allocation_swExecutionUnit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Allocation_swExecutionUnit_feature", "_UI_Allocation_type"),
				 oadPackage.Literals.ALLOCATION__SW_EXECUTION_UNIT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(oadPackage.Literals.ALLOCATION__BEHAVIOR_ITEM_REFERENCES);
		}
	...
	public String getText(Object object) {
		String label = ((Allocation)object).getSwExecutionUnit();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(oadPackage.Literals.ALLOCATION__BEHAVIOR_ITEM_REFERENCES,
				 oadFactory.eINSTANCE.createBehaviorItemReference()));
	}
