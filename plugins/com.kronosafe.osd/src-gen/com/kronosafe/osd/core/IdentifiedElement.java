 ...
 * </p>
 * <ul>
 *   <li>{@link com.kronosafe.osd.core.IdentifiedElement#getId <em>Id</em>}</li>
 * </ul>
 *
 * @see com.kronosafe.osd.core.corePackage#getIdentifiedElement()
 * @model abstract="true"
 * @generated
 */
public interface IdentifiedElement extends IdentifiableElementReferencer {
	 ...
	 * @see #setId(Integer)
	 * @see com.kronosafe.osd.core.corePackage#getIdentifiedElement_Id()
	 * @model id="true" dataType="com.kronosafe.osd.core.IdVal" required="true"
	 * @generated
	 */
	Integer getId();

	/**
	 * Sets the value of the '{@link com.kronosafe.osd.core.IdentifiedElement#getId <em>Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
