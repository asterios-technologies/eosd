 ...
 * </p>
 * <ul>
 *   <li>{@link com.kronosafe.osd.oasd.impl.GlobalImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.kronosafe.osd.oasd.impl.GlobalImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GlobalImpl extends IdentifiableElementReferencerImpl implements Global {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return oasdPackage.Literals.GLOBAL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, oasdPackage.GLOBAL__NAME, oldName, name));
	}
	...
	public void setType(TypeItem newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, oasdPackage.GLOBAL__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case oasdPackage.GLOBAL__NAME:
				return getName();
			case oasdPackage.GLOBAL__TYPE:
				return getType();
		}
