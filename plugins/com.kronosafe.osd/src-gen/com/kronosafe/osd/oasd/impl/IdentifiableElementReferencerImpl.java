...
public abstract class IdentifiableElementReferencerImpl extends MinimalEObjectImpl.Container implements IdentifiableElementReferencer {
	...
	protected EClass eStaticClass() {
		return oasdPackage.Literals.IDENTIFIABLE_ELEMENT_REFERENCER;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case oasdPackage.IDENTIFIABLE_ELEMENT_REFERENCER___FIND_ITEM__INTEGER_ECLASS:
				return findItem((Integer)arguments.get(0), (EClass)arguments.get(1));
			case oasdPackage.IDENTIFIABLE_ELEMENT_REFERENCER___FIND_ITEM__INTEGER_ESTRUCTURALFEATURE:
				return findItem((Integer)arguments.get(0), (EStructuralFeature)arguments.get(1));
			case oasdPackage.IDENTIFIABLE_ELEMENT_REFERENCER___FIND_ITEM_IN_RESOURCE_SET__INTEGER_ECLASS:
				return findItemInResourceSet((Integer)arguments.get(0), (EClass)arguments.get(1));
			case oasdPackage.IDENTIFIABLE_ELEMENT_REFERENCER___FIND_ITEM__INTEGER_ECLASS_RESOURCE:
