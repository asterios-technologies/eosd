 ...
 * @generated
 */
public class InputImpl extends IdentifiedElementImpl implements Input {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return oasdPackage.Literals.INPUT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, oasdPackage.INPUT__NAME, oldName, name));
	}
	...
	public void setInner(String newInner) {
		...
		inner = newInner;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, oasdPackage.INPUT__INNER, oldInner, inner));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
				case oasdPackage.INPUT__NAME: return oasdPackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
				case oasdPackage.NAMED_ELEMENT__NAME: return oasdPackage.INPUT__NAME;
				default: return -1;
			}
		}
