...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Timing Path Item</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.kronosafe.osd.oasd.impl.TimingPathItemImpl#getDate <em>Date</em>}</li>
 *   <li>{@link com.kronosafe.osd.oasd.impl.TimingPathItemImpl#getBehaviorItem <em>Behavior Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimingPathItemImpl extends IdentifiableElementReferencerImpl implements TimingPathItem {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return oasdPackage.Literals.TIMING_PATH_ITEM;
	}
	...
	public void setDate(Integer newDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, oasdPackage.TIMING_PATH_ITEM__DATE, oldDate, date));
	}
	...
	public BehaviorItem getBehaviorItem() {
		if (behaviorItem != null && behaviorItem.eIsProxy()) {
			...
			if (behaviorItem != oldBehaviorItem) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, oasdPackage.TIMING_PATH_ITEM__BEHAVIOR_ITEM, oldBehaviorItem, behaviorItem));
			}
		}
		return behaviorItem;
	}
	...
	public void setBehaviorItem(BehaviorItem newBehaviorItem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, oasdPackage.TIMING_PATH_ITEM__BEHAVIOR_ITEM, oldBehaviorItem, behaviorItem));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case oasdPackage.TIMING_PATH_ITEM__DATE:
				return getDate();
			case oasdPackage.TIMING_PATH_ITEM__BEHAVIOR_ITEM:
