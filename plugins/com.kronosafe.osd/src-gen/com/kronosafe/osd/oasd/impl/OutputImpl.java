 ...
 * @generated
 */
public class OutputImpl extends IdentifiedElementImpl implements Output {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return oasdPackage.Literals.OUTPUT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, oasdPackage.OUTPUT__NAME, oldName, name));
	}
	...
	public void setInner(String newInner) {
		...
		inner = newInner;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, oasdPackage.OUTPUT__INNER, oldInner, inner));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
				case oasdPackage.OUTPUT__NAME: return oasdPackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
				case oasdPackage.NAMED_ELEMENT__NAME: return oasdPackage.OUTPUT__NAME;
				default: return -1;
			}
		}
